...
export default function Login() {
    ...
    const handleLogin = async (event) => {
        ...
        if (result.ok) router.push('/')
            ...
            setModal(true) // Show modal error
            ...
            <div className="w-full sm:w-96 px-11">
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <div className="flex justify-between items-center mb-11 mt-4">
                        <a href="#" className="text-primary font-medium text-sm">Forgot Password</a>
                        <button type="submit" className="text-white bg-primary text-sm py-2.5 px-4 rounded text-center inline-flex items-center">
                            {
                ...
                <div className="text-center">
                    <p className="text-xs text-[#626060]">Don&apos;t have an account?</p>
                    <Link href={'/register'} passHref className="text-primary text-xs">
                        Register
                    </Link>
                </div>
            </div>
